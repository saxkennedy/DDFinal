...
public enum CharacterBackgroundEnum {
   ...
   /* ACOLYTE(0,"Acolyte", Skill.INSIGHT, Skill.RELIGION,
    ...
    CHARLATAN(1,"Charlatan", Skill.DECEPTION, Skill.SLEIGHTOFHAND,"You have always had a way with people. You know\n" +
            ...
            "are trying to copy."),
    CRIMINAL(2,"Criminal", Skill.DECEPTION, Skill.STEALTH,"You are an experienced criminal with a history of\n" +
    ...
    ENTERTAINER(3,"Entertainer", Skill.ACROBATICS, Skill.PERFORMANCE,"You thrive in front of an audience. You know how to\n" +
    ...
    FOLKHERO(4,"Folk Hero", Skill.ANIMALHANDLING, Skill.SURVIVAL,"You come from a humble social rank, but you are\n" +
            ...
            "their lives for you."),
    GUILDARTISAN(5,"Guild Artisan", Skill.INSIGHT, Skill.PERSUASION,"You are a member of an artisan guild, skilled in\n" +
    ...
    HERMIT(6,"Hermit", Skill.MEDICINE, Skill.RELIGION,"DISCOVERY: You lived in seclusion, either in a sheltered community\n" +
    ...
    NOBLE(7,"Noble", Skill.HISTORY, Skill.PERSUASION,"You understand wealth, power, and privilege. You\n" +
    ...
    OUTLANDER(8,"Outlander", Skill.ATHLETICS, Skill.SURVIVAL,"You grew up in the wilds, far from civilization and the\n" +
    ...
    SAGE(9,"Sage", Skill.ARCANA, Skill.HISTORY,"You spent years learning the lore of the multiverse. You\n" +
    ...
    SAILOR(10,"Sailor", Skill.ATHLETICS, Skill.PERCEPTION,"You sailed on a seagoing vessel for years. In that\n" +
            ...
            "during the voyage."),
    SOLDIER(11,"Soldier", Skill.ATHLETICS, Skill.PERCEPTION,"War has been your life for as long as you care to\n" +
            ...
            "rank is recognized."),
    URCHIN(12,"Urchin", Skill.SLEIGHTOFHAND, Skill.STEALTH,"You grew up on the streets alone, orphaned, and poor.\n" +
