...
public enum Race implements AbilityScoreChanger {
    ...
    Race(int strChanges, int dexChanges, int conChanges, int intChanges, int wisChanges, int chaChanges, int speed, String raceName, String viewName, String picture, String label) {
